...
import 'package:riverpod_learning/state_notifier/todo_provider.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          if (todoValue.isNotEmpty) {
            ref.read(todoNotifierProvider.notifier).addTodo(todoValue);
            return;
          }
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final todo = ref.watch(todoNotifierProvider)[index];
                    return Dismissible(
