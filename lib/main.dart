...
import 'package:riverpod_learning/state_provider/state_provider_page.dart';
    ...
    return MaterialApp(
      ...
      routes: {
        BasicProviderScreen.routePath: (BuildContext context) =>
            BasicProviderScreen(),
        StateProviderPage.routePath: (BuildContext context) =>
            StateProviderPage(),
      },
    );
  }
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            NavigationButton(
              onPressed: () {
                Navigator.pushNamed(context, StateProviderPage.routePath);
              },
              destination: "State",
            ),
          ],
